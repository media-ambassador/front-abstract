...
var MaSliderNavPrevDirective = /** @class */ (function () {
    ...
    MaSliderNavPrevDirective.prototype.onClick = function () {
        if (this.maSlider) {
    ...
    /** @nocollapse */
    MaSliderNavPrevDirective.ctorParameters = function () { return []; };
    MaSliderNavPrevDirective.propDecorators = {
        "maSlider": [{ type: core_1.Input, args: ['maSliderNavPrev',] },],
        "maTime": [{ type: core_1.Input },],
        "active": [{ type: core_2.HostBinding, args: ['class.' + slider_component_1.maSliderCssClassNavPrevActive,] },],
