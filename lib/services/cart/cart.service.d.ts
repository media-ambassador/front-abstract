...
export declare class MaCartService {
    protected apiCartService: MaApiCartService<MaApiCartListResponse, MaApiSetItemData, MaApiSetItemResponse, MaApiSetDeliveryData, MaApiResponse, MaApiSetPaymentData, MaApiMakeOrderData, MaApiMakeOrderResponse>;
    ...
    constructor(apiCartService: MaApiCartService<MaApiCartListResponse, MaApiSetItemData, MaApiSetItemResponse, MaApiSetDeliveryData, MaApiResponse, MaApiSetPaymentData, MaApiMakeOrderData, MaApiMakeOrderResponse>, authService: MaAuthService);
