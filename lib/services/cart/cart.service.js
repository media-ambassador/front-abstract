...
var MaCartService = /** @class */ (function () {
    ...
    MaCartService.prototype.getProduct = function (id) {
        return find_1.default(this.cartList.data.items, function (item) {
    ...
    MaCartService.prototype.getSingleItemsCount = function () {
    ...
    MaCartService.prototype.getSelectedPaymentOption = function () {
        var selected = this.cartList.data.payment.selected;
        return find_1.default(this.cartList.data.payment.options, function (item) {
    ...
    MaCartService.prototype.getSelectedDeliveryOption = function () {
        ...
        return find_1.default(this.cartList.data.delivery.options, function (item) {
            // tslint:disable-next-line:triple-equals
    ...
    MaCartService.prototype.getParcelName = function (option) {
        if (option === void 0) { option = null; }
        var hasParcel = this.isDeliveryInpost() || this.isSalonDelivery();
        if (!hasParcel) {
            return null;
        }
        var deliveryOption = !!option ? option : this.getSelectedDeliveryOption();
    ...
    MaCartService.prototype.makeOrder = function (makeOrderData) {
        var _this = this;
        return this.apiCartService.makeOrder(makeOrderData).pipe(operators_1.tap(function (response) { return _this.makeOrderResponse(response); }));
    };
    MaCartService.prototype.makeOrderResponse = function (response) {
        if (response.action_status) {
