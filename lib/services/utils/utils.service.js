...
var MaUtilsService = /** @class */ (function () {
    ...
    MaUtilsService.prototype.isSupportActive = function (hourFrom, hourTo, minuteFrom, minuteTo) {
        if (minuteFrom === void 0) { minuteFrom = 0; }
        if (minuteTo === void 0) { minuteTo = 0; }
        var day = moment().day();
        var isWeekend = day === 0 || day === 6 ? true : false;
        var isOpen = moment().isAfter(moment({ hour: hourFrom, minute: minuteFrom })) && moment().isBefore(moment({ hour: hourTo, minute: minuteTo })) ? true : false;
