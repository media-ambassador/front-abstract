...
export interface MaApiOrderListItem<P extends MaApiCartPrice<MaApiCartPriceInfo<MaApiPriceDetails<MaApiPriceCurrency>>>, D extends MaApiProductDiscount<MaApiPriceDetails<MaApiPriceCurrency>>, A extends MaApiCartProductAttribute, PV extends MaApiProductVariation<MaApiProductAttribute, MaApiProductImage, MaApiShopData>> {
    product_id?: string;
    quantity?: string;
    product_code?: any;
    display_name?: string;
...
export interface MaApiOrderListData<PC extends MaApiPriceCurrency, PD extends MaApiPriceDetails<PC>, O extends MaApiOrderListItem<MaApiCartPrice<MaApiCartPriceInfo<PD>>, MaApiProductDiscount<PD>, MaApiCartProductAttribute, MaApiProductVariation<MaApiProductAttribute, MaApiProductImage, MaApiShopData>>, A extends MaApiAddressData<MaApiAddressType>, D extends MaApiDeliveryOption<PD, MaApiParcelShopData<MaApiDeliveryParcelData>>, PO extends MaApiPaymentOption, OS extends MaApiOrderStatus, PP extends MaApiProductPrice<MaApiPriceInfo<PD>>> {
    created?: number;
    currency?: PC;
    id?: string;
    code?: string;
