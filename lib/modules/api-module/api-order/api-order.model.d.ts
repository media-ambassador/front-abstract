...
export interface MaApiOrderListItem<P extends MaApiCartPrice<MaApiCartPriceInfo<MaApiPriceDetails<MaApiPriceCurrency>>>, D extends MaApiProductDiscount<MaApiPriceDetails<MaApiPriceCurrency>>, A extends MaApiCartProductAttribute> {
    product_id?: string;
    quantity?: string;
    product_code?: any;
    display_name?: string;
