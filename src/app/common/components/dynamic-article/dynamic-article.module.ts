...
import { MaComponentDeclarations, MaDynamicArticleDeclarationFactory } from './component-declarations/declarations';
...
import { MaDynamicDeclarationService, ComponentDeclarationsName } from './dynamic-declaration.service';

export function MaDynamicDeclarationCreator(dynamicArticleFactoryService: MaDynamicArticleFactoryService, customDeclarations: MaComponentDeclarations) {
  return new MaDynamicDeclarationService(dynamicArticleFactoryService, customDeclarations).init();
}
  ...
  static forRoot(customDeclaration: MaComponentDeclarations = {}): ModuleWithProviders {
    return {
      ...
      providers: [
        ...
        {
          provide: MaDynamicDeclarationService,
          useFactory: MaDynamicDeclarationCreator,
          deps: [ MaDynamicArticleFactoryService, ComponentDeclarationsName ]
        }
      ]
    };
  }
